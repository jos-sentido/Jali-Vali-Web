...
export const stats = [
  ...
  { num: 5, suffix: "", label: "Líneas de infraestructura crítica", detail: "Hidráulica, sanitaria, pluvial, eléctrica y especial" },
...
export const services = [
  {
    ...
    image: "/brand/obras/desazolve-canal.jpg",
    items: [
  ...
  },
  {
    ...
    image: "/brand/obras/pipeline.jpg",
    items: [
  ...
  },
  {
    ...
    image: "/brand/obras/liniero-torre.jpg",
    items: [
...
export const machinery = [
  { name: "Excavadoras", units: 10 },
  { name: "Excavadoras anfibias", units: 3 },
  { name: "Retroexcavadoras", units: 15 },
  { name: "Bulldozers", units: 2 },
  { name: "Cargadores frontales", units: 4 },
  { name: "Motoniveladoras", units: 4 },
  { name: "Vibrocompactadores", units: 4 },
  { name: "Compactadores terraceros", units: 4 },
];
...
export const valueProps = [
  ...
  "Experiencia en infraestructura crítica",
...
export const featuredProjects = [
  { title: "Desazolve y encauzamiento de cauce", category: "Hidráulica", client: PLACEHOLDER, year: PLACEHOLDER, image: "/brand/obras/desazolve-canal.jpg" },
  { title: "Red de drenaje sanitario", category: "Sanitaria", client: PLACEHOLDER, year: PLACEHOLDER, image: "/brand/obras/pipeline.jpg" },
  { title: "Colector pluvial de gran diámetro", category: "Pluvial", client: PLACEHOLDER, year: PLACEHOLDER, image: "/brand/obras/construccion-pluvial.jpg" },
  { title: "Subestación e instalaciones eléctricas", category: "Eléctrica", client: PLACEHOLDER, year: PLACEHOLDER, image: "/brand/obras/torres-transmision.jpg" },
  { title: "Cárcamo de bombeo y pozos de visita", category: "Sanitaria", client: PLACEHOLDER, year: PLACEHOLDER, image: "/brand/obras/pozos-visita.jpg" },
  { title: "Obras complementarias y bocas de tormenta", category: "Especiales", client: PLACEHOLDER, year: PLACEHOLDER, image: "/brand/obras/bocas-tormenta.jpg" },
];
