...
export const featuredProjects = [
  { title: "Proyecto de desazolve y encauzamiento", category: "Hidráulica", client: PLACEHOLDER, year: PLACEHOLDER },
  { title: "Red de drenaje sanitario", category: "Sanitaria", client: PLACEHOLDER, year: PLACEHOLDER },
  { title: "Colector pluvial de gran diámetro", category: "Pluvial", client: PLACEHOLDER, year: PLACEHOLDER },
  { title: "Subestación e instalaciones eléctricas", category: "Eléctrica", client: PLACEHOLDER, year: PLACEHOLDER },
  { title: "Cárcamo de bombeo y línea de impulsión", category: "Sanitaria", client: PLACEHOLDER, year: PLACEHOLDER },
  { title: "Instalaciones especiales contra incendio", category: "Especiales", client: PLACEHOLDER, year: PLACEHOLDER },
];
